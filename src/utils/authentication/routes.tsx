...
export const routes: RouteT[] = [
    ...
    { path: '/groups/new',      element: <NewGroupPage />,          showSidebar: false, adminOnly: true },
    { path: '/groups/:name',    element: <GroupDetailsPage />,      showSidebar: false, adminOnly: false },
    { path: '/users',           element: <ManageUsersPage />,       showSidebar: true,  adminOnly: true,  menu: { label: 'Manage Users',           icon: IconUser } },
    { path: '/users/new',       element: <NewUserPage />,           showSidebar: false, adminOnly: true },
    { path: '/users/:username', element: <UserDetailsPage />,       showSidebar: false, adminOnly: true },
